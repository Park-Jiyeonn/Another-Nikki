...
func (s *problemRepo) CreateProblem(ctx context.Context, problemId int64, title, description, content string) (err error) {
	return
}
func (s *problemRepo) GetProblemById(ctx context.Context, problemId int64) (problemTitle, problemDescription, problemContent, createTime string, err error) {
	return
}
func (s *problemRepo) GetProblemByPage(ctx context.Context, pageNum, pageSize int64) (problems []*biz.Problems, err error) {
	return
}
