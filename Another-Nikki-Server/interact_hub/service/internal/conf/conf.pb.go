...
type Bootstrap struct {
	...
	Avatars       *Avatars       `protobuf:"bytes,3,opt,name=avatars,proto3" json:"avatars,omitempty"`
	ClientTimeout *ClientTimeout `protobuf:"bytes,4,opt,name=client_timeout,json=clientTimeout,proto3" json:"client_timeout,omitempty"`
}
...
func (x *Bootstrap) GetAvatars() *Avatars {
	if x != nil {
		return x.Avatars
	}
	return nil
...
func (x *Bootstrap) GetClientTimeout() *ClientTimeout {
	if x != nil {
...
type Data struct {
	...
	JudgeServiceAddr string         `protobuf:"bytes,3,opt,name=judgeServiceAddr,proto3" json:"judgeServiceAddr,omitempty"`
}
...
func (x *Data) GetJudgeServiceAddr() string {
	if x != nil {
		return x.JudgeServiceAddr
	}
	return ""
}
...
func (x *Avatars) GetAvatars() []string {
	if x != nil {
		return x.Avatars
	}
	return nil
...
func (x *ClientTimeout) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClientTimeout) ProtoMessage() {}

func (x *ClientTimeout) ProtoReflect() protoreflect.Message {
	mi := &file_conf_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClientTimeout.ProtoReflect.Descriptor instead.
func (*ClientTimeout) Descriptor() ([]byte, []int) {
	return file_conf_proto_rawDescGZIP(), []int{4}
}

func (x *ClientTimeout) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
var file_conf_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xce, 0x01, 0x0a, 0x09, 0x42, 0x6f, 0x6f,
	...
	,
	...
	0x65, 0x6f, 0x75, 0x74, 0x22, 0x89, 0x03, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a,
	...
	0x69, 0x73, 0x12, 0x2a, 0x0a, 0x10, 0x6a, 0x75, 0x64, 0x67, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x41, 0x64, 0x64, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x6a, 0x75,
	0x64, 0x67, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x41, 0x64, 0x64, 0x72, 0x1a, 0x3a,
	...
	0x22, 0x23, 0x0a, 0x07, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x61,
	0x76, 0x61, 0x74, 0x61, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x61, 0x76,
	0x61, 0x74, 0x61, 0x72, 0x73, 0x22, 0x44, 0x0a, 0x0d, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x54,
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x08, 0x5a, 0x06, 0x2e,
...
var file_conf_proto_goTypes = []interface{}{
	...
	(*Avatars)(nil),             // 3: kratos.api.Avatars
	(*ClientTimeout)(nil),       // 4: kratos.api.ClientTimeout
...
var file_conf_proto_depIdxs = []int32{
	...
	3,  // 2: kratos.api.Bootstrap.avatars:type_name -> kratos.api.Avatars
	4,  // 3: kratos.api.Bootstrap.client_timeout:type_name -> kratos.api.ClientTimeout
	...
	9,  // 8: kratos.api.ClientTimeout.timeout:type_name -> google.protobuf.Duration
