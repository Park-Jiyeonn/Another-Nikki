...
func RunCode(c *gin.Context) {
	...
	args := []string{
		...
		"cpp_compile",
		"-v",
		fmt.Sprintf("%s/code:/dox", os.Getenv("PWD")),
		"cpp_env:1",
		"sh",
		"-c",
		"g++ 'c++.cpp' -o 'cpp' -O2 -std=c++11 2> compile.log",
	}
	...
	compileCmd := exec.Command(compileCommand, args...)
	runCmd := exec.Command(runCommand, runArgs...)
