...
func NewGRPCServer(c *conf.Server, code_processing *service.CodeProcessingService, logger log.Logger) *grpc.Server {
	...
	api.RegisterCodeProcessingServer(srv, code_processing)
	return srv
}
