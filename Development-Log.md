...
这一年发生了很多事情，哈哈，西安、昆明、武汉...这些就不在这里提了

记录下代码的修改吧，去年看到过 $sqlite$，于是决定不用 $mysql$ 了，自己的服务器就这点访问量，$sqlite$ 足矣。

得益于 $Kratos$ 的插件思想，还有以前的代码写的也很规范，换用起来并不麻烦，新实现一套查询，然后在 $wire$ 里换用即可。
